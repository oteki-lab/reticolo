...
%%%%
%%%% Unit of length; everything is in μm
%%%%
...
h_2pts=20;                           % distance between 2 points in z pour the layers whose thickness is higher than 1μm (trace_champ=1)
...
parfor zou=1:length(wavelength)
    ...
    disp(['Calculation nｰ' int2str(zou) ' of ' int2str(length(wavelength))])
