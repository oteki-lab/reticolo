...
%%%%
%%%% Unit of length; everything is in ƒÊm
%%%%
...
h2=0.16; % AlInP Thickness of layer 2 (0 si if no layer)
h3=0.14;                           % AlInP Thickness of layer 3 (0 si if no layer)
h4=1.7;                           % GaAs Thickness of layer 4 (0 si if no layer)
h5=0.04;                             % Thickness of layer 5 (0 si if no layer)
...
n10=1.598*ones(size(wavelength));                               % index between the structures of layer 10
n10m=retindice_chen(wavelength,4.802);                              % index inside the structures of layer 10 (0 if not structured)
n11=1.598*ones(size(wavelength));                               % index between the structures of layer 11
...
h_2pts=20;                           % distance between 2 points in z pour the layers whose thickness is higher than 1ƒÊm (trace_champ=1)
...
figure
pcolor(xx,zz,abs(Ey).^2);shading interp;colormap(jet);hold on
