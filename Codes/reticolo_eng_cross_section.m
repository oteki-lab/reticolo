...
h6=0.04;                             % Thickness of layer 6 (0 si if no layer)                               % Thickness of layer 6 (0 si if no layer)
h7=0.18;                               % Thickness of layer 7 (0 si if no layer)
h8=0.18;                               % Thickness of layer 8 (0 si if no layer)
h9=0.18;                               % Thickness of layer 9 (0 si if no layer)
h10=0.18;                              % Thickness of layer 10 (0 si if no layer)
h11=0.18;                              % Thickness of layer 11 (0 si if no layer)
...
n1m=1.85*ones(size(wavelength));%AlInP
...
n6=1.6*ones(size(wavelength)); % gaas index between the structures of layer 4
n6m=retindice_chen(wavelength,4.802);    % argent index inside the structures of layer 4 (0 if not structured)
n7=1.6*ones(size(wavelength));   % AlInP argentindex between the structures of layer 5
n7m=retindice_chen(wavelength,4.802); 
n8=1.6*ones(size(wavelength));   % Ag index between the structures of layer 7
n8m=retindice_chen(wavelength,4.802);                               % index inside the structures of layer 7 (0 if not structured)
n9=1.6*ones(size(wavelength));                                % index between the structures of layer 9
n9m=retindice_chen(wavelength,4.802);                               % index inside the structures of layer 9 (0 if not structured)
n10=1.6*ones(size(wavelength));                               % index between the structures of layer 10
n10m=retindice_chen(wavelength,4.802);                              % index inside the structures of layer 10 (0 if not structured)
n11=1.6*ones(size(wavelength));                               % index between the structures of layer 11
...
nsub=retindice_chen(wavelength,1.72); % Ag argent index of the substrate%%%%%% Numerical parameters
...
Nb_pts_z=30;                         % Number of points in z to calculate absorption, when absorption is calculated in each layer
...
x0=p/2;                                % Cross section along x=x0 if trace_champ=1 ([] if the cross-section is along another direction)
...
h_2pts=20;                           % distance between 2 points in z for the layers whose thickness is higher than 1É m (trace_champ=1)
...
parfor zou=1:length(wavelength)
    ...
    for az=1:Nb_couches
        if Nm(az)==0
            ...
            if 5<az&&az<12
%                 structure1=[-0.215,-0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
%                 structure2=[-0.215,0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
%                 structure3=[0.215,-0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
%                 structure4=[0.215,0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];               structure1=[-0.215,-0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
  
                structure1=[-0.215,-0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure2=[-0.215,0,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure3=[-0.215,0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure4=[0,-0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure5=[0,0,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure6=[0,0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure7=[0.215,-0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure8=[0.215,0,diameter_x(az),diameter_y(az),Nm(az),Ntre];
                structure9=[0.215,0.215,diameter_x(az),diameter_y(az),Nm(az),Ntre];
            
                texture={N(az),structure1,structure2,structure3,structure4,structure5,structure6,structure7,structure8,structure9,k0};
%                 texture={N(az),structure1,structure2,structure3,structure4,k0};
...
plot(wavelength,Abs(3,:)+Abs(4,:)+Abs(5,:),'Linewidth',3,'Linestyle','-.')
xlabel('\lambda (É m)')
ylabel('Absorption')
