...
if ischar(a);if isreal(y);yy(ordre)=interp1(x,y,xx,a);else;yy(ordre)=interp1(x,real(y),xx,a)+1i*interp1(x,imag(y),xx,a);end;yy=reshape(yy,siz);return;end;%  Matlab
% modif 10 2011 seul pchip n'interpole pas re et im separement et peut produire des delires...
