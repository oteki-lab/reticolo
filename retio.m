...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Attention: au dela de la version 7.10 retio est neutralis� par defaut.Pour l'utiliser, faire [prv,vmax]=retio([],5000i)
...
%          seuls les objets de taille>vmax sont stock�s (taille=nombre de complexes)
...
% dans le m�me repertoire,les noms de fichiers sont pr�c�d�s d'un prefixe
...
% a=retio(a,-2)  lecture de a en effa�ant le fichier
% retio(a,-1)    effa�age du fichier (ou clear a)
% retio effa�age de tous les fichiers 
...
%  remarque: v7.3 permet d'enregistrer de tr�s gros fichiers (>2GB) mais si on repete l'ecriture risque de bugg
...
if ischar(fich);a=retio(retio(a),fich,varargin{:});return;end; % a est lu puis stock� en un fichier permanent
...
if k==4;% a=size de l'objet stock� ,vm= taille du fichier de a sans ses satellites, dimgs,dimensions et repetion pour les matrices S
