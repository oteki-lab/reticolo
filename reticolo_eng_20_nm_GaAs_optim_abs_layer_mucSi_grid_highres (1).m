...
for i=1:length(sequence)
    ...
    h6=sequence{i}(3);                               % Thickness of layer 6 (0 si if no layer)
    h7=0.100;                               % Thickness of layer 7 (0 si if no layer)
    ...
    n1=retindice_dielec(wavelength,23.31,'makima');       % index between the structures of layer 1
    n1m=0;      % index inside the structures of layer 1 (0 if not structured)
    n2=retindice_dielec(wavelength,23.5,'makima');  % index between the structures of layer 2
    n2m=0;                               % index inside the structures of layer 2 (0 if not structured)
    n3=retindice_semicond(wavelength,4.605,'makima');  % index between the structures of layer 3
    n3m=0;                               % index inside the structures of layer 3 (0 if not structured)
    n4=retindice_semicond(wavelength,41.01,'makima'); % index between the structures of layer 4
    n4m=0;                               % index inside the structures of layer 4 (0 if not structured)
    n5=retindice_semicond(wavelength,4.605,'makima');   % index between the structures of layer 5
    n5m=0;                               % index inside the structures of layer 5 (0 if not structured)
    n6=retindice_semicond(wavelength,18,'makima');                                % index between the structures of layer 6
    n6m=sequence{i}(4)*ones(1,length(wavelength));                               % index inside the structures of layer 6 (0 if not structured)
    n7=sequence{i}(4)*ones(1,length(wavelength));                                % index between the structures of layer 7
    n7m=0;                               % index inside the structures of layer 7 (0 if not structured)
    n8=retindice_metal(wavelength,1.9,'makima');                                % index between the structures of layer 8
    ...
    nsub=ones(1,length(wavelength)); % index of the substrate
    ...
    % AbsRCWA=1-R0_TE_TE;
    text=['AbsRCWA_20nm_GaAs','wav',int2str(wavelength(1)*1000),'_',int2str(wavelength(end)*1000),'_period_',int2str(periodicity_x*1000),'_diam_',int2str(diameter_x*1000),'h_struc',int2str(h6*1000) ,'_h_plan_' ,num2str(h7*1000), '_n_plan_', num2str(n6m(1)), '_Fourier',int2str(Mx),'_nbpoints',int2str(length(wavelength)),'_muc_Si_grid.mat'];
...
%     plot(wavelength,Abs_plots(6,:),'Linewidth',2)
%     plot(wavelength,Abs(8,:),'Linewidth',3)
