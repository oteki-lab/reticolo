...
params = {
    ...
    periodicity_x,          0.04,   retindice_chen(wavelength,4.802),   0.00*ones(size(wavelength));        % 
    backgrating_x*23,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*22,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*21,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*20,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*19,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*18,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*17,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*16,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*15,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*14,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
    backgrating_x*13,       0.9/12, retindice_chen(wavelength,1.73),    retindice_chen(wavelength,4.802);   % 
